...
#' Proximal Gradient Algorithm for Multi-variate Sparse Group Lasso.
#' 
#' @usage PgaMsgl(XX, YY, B0, model = c("L020v1", "L020v2", "L121"), Gm, mi = 1000, mg, mc, minlambda = 1e-5, rlambda = 0.98, mintau = 1e-5, rtau = 0.98)
#' 
...
#' 
#' @export
PgaMsgl <- function(XX, YY, B0, model=c("L020v1", "L020v2", "L121"), Gm, mi=1000, mg, mc, minlambda = 1e-5, rlambda = 0.98, mintau = 1e-5, rtau = 0.98)
{
  if(model=="L020v1"){
    L020v1(XX, YY, B0, Gm, mi, mg, mc)
  } else if (model=="L020v2"){
    L020v2(XX, YY, B0, Gm, mi, mg, mc, minlambda, rlambda, mintau, rtau)
  } else if (model=="L121") {
    L121(XX, YY, B0, Gm, mi, mg, mc)
  } else {
